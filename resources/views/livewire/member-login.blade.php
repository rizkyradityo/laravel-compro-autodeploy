                ...
                <div class="col-lg-5 col-md-8">
                    ...
                    <div class="member-card">
                        <div class="member-card__header">
                            ...
                            <h3 class="member-card__title">Selamat Datang Kembali</h3>
                            <p class="member-card__subtitle">Masuk ke akun member Anda</p>
                        </div>

                        <form wire:submit="login" class="member-form">
                            ...
                            <div class="member-form__checkbox">
                                <input wire:model="remember" id="remember" type="checkbox" class="member-form__checkbox-input">
                                <label for="remember" class="member-form__checkbox-label">Ingat saya</label>
                            </div>
                        ...
                        <div class="member-card__footer">
                            Belum punya akun?
                            <a href="{{ route('member.register') }}" class="member-card__link">Daftar Sekarang</a>
                        </div>
                    </div>
